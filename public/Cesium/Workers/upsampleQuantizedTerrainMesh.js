 ...
 */
import { a as ue } from "./chunk-5K4QFLQS.js";
import { a as Ae } from "./chunk-BUKMP3AW.js";
import { a as ee } from "./chunk-KCM7BPUF.js";
import { a as be, c as Ne } from "./chunk-TJPKIFSX.js";
import "./chunk-4U4JDPPY.js";
import "./chunk-D5QCMU6T.js";
import "./chunk-JKEOJFWC.js";
import "./chunk-FWQONNTL.js";
import { c as de } from "./chunk-OXROQHTA.js";
import { a as Ve } from "./chunk-Z7UZ2XGJ.js";
import "./chunk-GQG3G4OP.js";
import { j as Se } from "./chunk-4JSGO3Z7.js";
import "./chunk-V62DYOIH.js";
import "./chunk-54IT5KT4.js";
import "./chunk-E6GK7MVP.js";
import "./chunk-YQTAAITT.js";
import { a as N } from "./chunk-3XRQCEHV.js";
import { e as f } from "./chunk-4TAASUQ2.js";
import { a as A } from "./chunk-TODZU3UG.js";
import { b as q, a as V } from "./chunk-VIWNLE3Z.js";
import { c as Ce, a as Ie, b as Z } from "./chunk-WV2SHQ7E.js";

var ne = {};
ne.clipTriangleAtAxisAlignedThreshold = (n, h, o, i, s, e) => {
...
ne.computeBarycentricCoordinates = (n, h, o, i, s, e, g, w, c) => {
...
ne.computeLineSegmentLineSegmentIntersection = (n, h, o, i, s, e, g, w, c) => {
...
function je(n, h) {
	...
	for (t = 0, k = 0; t < Y; ++t, k += 2) {
		const v = R.decodeTextureCoordinates(I, t, Ge);
		if (
			...
			const Q = R.getOctEncodedNormal(I, t, $e);
			(F[k] = Q.x), (F[k + 1] = Q.y);
		}
		((o && x >= z) || (!o && x <= z)) &&
			((i && y >= z) || (!i && y <= z)) &&
	...
	for (t = 0; t < C.length; t += 3) {
		...
		const P = ie.clipTriangleAtAxisAlignedThreshold(z, o, De, Fe, ke, Me);
		(b = 0),
			!(b >= P.length) &&
	...
	for (ce < xe && (ce += N.TWO_PI), t = 0; t < c.length; ++t)
		(x = Math.round(c[t])),
			...
			M.push(E.y),
			M.push(E.z);
	const he = de.fromVertices(M, A.ZERO, 3, Qe),
