...
import { c as g } from './chunk-TODZU3UG.js';
import { b as n } from './chunk-VIWNLE3Z.js';
import { d as j } from './chunk-WV2SHQ7E.js';
...
e.fromRgba = (r, o) => ((A[0] = r), e.fromBytes(E[0], E[1], E[2], E[3], o));
e.fromHsl = (r, o, t, f, C) => {
...
e.fromCssColorString = (r, o) => {
  n.typeOf.string('color', r), b(o) || (o = new e()), (r = r.trim());
  const t = e[r.toUpperCase()];
...
e.byteToFloat = (r) => r / 255;
e.floatToByte = (r) => (r === 1 ? 255 : (r * 256) | 0);
e.clone = (r, o) => {
  if (b(r))
    return b(o)
      ? ((o.red = r.red),
...
e.prototype.toCssColorString = function () {
  const r = e.floatToByte(this.red),
...
e.prototype.toBytes = function (r) {
  const o = e.floatToByte(this.red),
...
e.bytesToRgba = (r, o, t, f) => (
  (E[0] = r), (E[1] = o), (E[2] = t), (E[3] = f), A[0]
);
