 ...
 */
import { a as Q } from "./chunk-3XRQCEHV.js";
import { i as fe, h as Z } from "./chunk-4JSGO3Z7.js";
import { e as $ } from "./chunk-4TAASUQ2.js";
import { a as te } from "./chunk-4U4JDPPY.js";
import { a as _ } from "./chunk-EOGEW5R4.js";
import { a as e, b as O } from "./chunk-TODZU3UG.js";
import { a as ie, b as j } from "./chunk-V62DYOIH.js";
import { a as le } from "./chunk-VIWNLE3Z.js";
import { b as ee, a as se } from "./chunk-WV2SHQ7E.js";
...
R.angleIsGreaterThanPi = (r, n, a, o) => {
	const t = new te(a, o),
		c = t.projectPointOntoPlane(e.add(a, r, X), X),
		f = t.projectPointOntoPlane(e.add(a, n, Y), Y);
...
R.computePositions = (r, n, a, o, t) => {
	...
	for (let U = 1; U < i - 1; U++) {
		...
		(y = e.subtract(M, p, y)),
			(y = e.normalize(y, y)),
			(E = c.geodeticSurfaceNormal(p, E));
		const L = e.multiplyByScalar(E, e.dot(y, E), Le);
		e.subtract(y, L, L), e.normalize(L, L);
		const q = e.multiplyByScalar(E, e.dot(b, E), qe);
		if (
			(e.subtract(b, q, q),
			e.normalize(q, q),
			...
			(h = e.add(y, b, h)),
				...
				(h = e.cross(E, h, h)),
				(h = e.normalize(h, h));
			const k = 1 / Math.max(0.25, e.magnitude(e.cross(h, b, I))),
