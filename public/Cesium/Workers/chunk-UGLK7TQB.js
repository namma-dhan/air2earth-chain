...
import { h as I } from './chunk-4JSGO3Z7.js';
import { e as j } from './chunk-4TAASUQ2.js';
import { a as U } from './chunk-EOGEW5R4.js';
import { c as q, a as z } from './chunk-MPA4R2GB.js';
import { b as C, a as e } from './chunk-TODZU3UG.js';
...
function V(o, s, a, c, r) {
  const d = e.angleBetween(e.subtract(s, o, B), e.subtract(a, o, J)),
...
G.computePositions = (o) => {
  ...
  for (M = 1; M < Y - 1; M++) {
    (n = c.geodeticSurfaceNormal(h, n)),
      (N = a[M + 1]),
      (l = e.normalize(e.subtract(N, h, l), l));
    const L = e.multiplyByScalar(n, e.dot(l, n), le);
    e.subtract(l, L, L), e.normalize(L, L);
    const R = e.multiplyByScalar(n, e.dot(m, n), ce);
    if (
      (e.subtract(m, R, R),
      e.normalize(R, R),
      ...
      (i = e.normalize(e.add(l, m, i), i)),
        ...
        (i = e.cross(n, i, i)),
        (i = e.normalize(i, i));
      const Z = r / Math.max(0.25, e.magnitude(e.cross(i, m, B))),
