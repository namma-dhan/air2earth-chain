 ...
 */
import { j as W, c as X } from './chunk-4JSGO3Z7.js';
import { a as J } from './chunk-BUKMP3AW.js';
import { a as Y } from './chunk-KCM7BPUF.js';
import { a as B } from './chunk-Z7UZ2XGJ.js';
...
import { c as _, a as k } from './chunk-WV2SHQ7E.js';
    ...
    for (let D = 0; D < y; D++) {
      ...
      if (D === 0) {
        ...
        if (t.equals(K, S)) t.unpack(m, U - 3, L);
          ...
          const nt = t.subtract(S, O, M);
          L = t.add(nt, S, M);
        }
      } else t.unpack(m, I - 3, L);
      if (D === y - 1) {
        const U = t.unpack(m, q, T);
        if (t.equals(U, O)) t.unpack(m, q + 3, R);
        else {
          const K = t.subtract(O, S, T);
          R = t.add(K, O, T);
        }
