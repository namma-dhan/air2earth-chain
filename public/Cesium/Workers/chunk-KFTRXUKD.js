 ...
 */
import { a as $ } from "./chunk-3XRQCEHV.js";
import {
	b as $b,
	e as Fb,
	d as hb,
	...
	i as Ta,
	j as xa,
} from "./chunk-4JSGO3Z7.js";
import { e as Q, d as Qb } from "./chunk-4TAASUQ2.js";
import { a as ra } from "./chunk-5K4QFLQS.js";
import { a as tb } from "./chunk-54IT5KT4.js";
import { a as Ea } from "./chunk-ATZCLKEP.js";
import { a as Ha } from "./chunk-D5QCMU6T.js";
import { b as gb, a as ib } from "./chunk-JKEOJFWC.js";
import { a as rb } from "./chunk-KCM7BPUF.js";
import { b as db, c as wa } from "./chunk-OXROQHTA.js";
import { a as Ma } from "./chunk-OXTEQVCI.js";
import { c as Fa, b as Pa, a as Ub } from "./chunk-TJPKIFSX.js";
import { c as fb, a as u, b as ya } from "./chunk-TODZU3UG.js";
import { b as P } from "./chunk-V62DYOIH.js";
import { a as Ia, b as J } from "./chunk-VIWNLE3Z.js";
import { c as Aa, b as K, d as nb, a as V } from "./chunk-WV2SHQ7E.js";
import { a as za } from "./chunk-YQTAAITT.js";
...
var De = (() => {
	...
	var e,
		g = WebAssembly.instantiate(s(c), {}).then((k) => {
			(e = k.instance),
	...
	function E(k, j, d, n) {
		...
		return (
			new Uint8Array(i.buffer).set(f.subarray(a, a + d * 4)), t(a - t(0)), i
		);
	}
...
var Ua = (() => {
	...
	var s = WebAssembly.validate(e) ? p(o) : p(c),
		b,
		r = WebAssembly.instantiate(s, {}).then((t) => {
...
var Te = (() => {
	...
	if (typeof WebAssembly != "object") return { supported: !1 };
	var e,
		g = WebAssembly.instantiate(s(c), {}).then((a) => {
	...
	function p(a, h, f, i) {
		...
		return (
			new Uint8Array(N.buffer).set(x.subarray(m, m + f * 4)), l(m - l(0)), N
		);
	}
	function E(a, h, f) {
	...
	return {
		...
		simplify: (a, h, f, i, l, m) => {
			...
			return (
				(v[0] = a instanceof Uint32Array ? v[0] : new a.constructor(v[0])), v
			);
		},
		simplifyWithAttributes: (a, h, f, i, l, m, w, x, N, v) => {
			b(
				a instanceof Uint32Array ||
					a instanceof Int32Array ||
					a instanceof Uint16Array ||
			...
			return (
				(M[0] = a instanceof Uint32Array ? M[0] : new a.constructor(M[0])), M
			);
		},
		simplifyWithUpdate: (a, h, f, i, l, m, w, x, N, v) => {
			b(
				a instanceof Uint32Array ||
					a instanceof Int32Array ||
					a instanceof Uint16Array ||
		...
		simplifySloppy: (a, h, f, i, l, m) => {
			...
			return (
				(x[0] = a instanceof Uint32Array ? x[0] : new a.constructor(x[0])), x
			);
		},
		simplifyPrune: (a, h, f, i) => {
			b(
				a instanceof Uint32Array ||
					a instanceof Int32Array ||
					a instanceof Uint16Array ||
...
var Pe = (() => {
	...
	if (typeof WebAssembly != "object") return { supported: !1 };
	var e,
		g = WebAssembly.instantiate(s(c), {}).then((d) => {
	...
	return {
		...
		buildMeshletsFlex: (d, n, t, a, h, f, i, l) => {
			b(d.length % 3 == 0),
				b(n instanceof Float32Array),
				b(n.length % t == 0),
				b(t >= 3),
		...
		buildMeshletsSpatial: (d, n, t, a, h, f, i) => {
			b(d.length % 3 == 0),
				b(n instanceof Float32Array),
				b(n.length % t == 0),
				b(t >= 3),
		...
		extractMeshlet: (d, n) => (b(n >= 0 && n < d.meshletCount), F(d, n)),
		computeClusterBounds: (d, n, t) => {
			b(d.length % 3 == 0),
				b(d.length / 3 <= 512),
				b(n instanceof Float32Array),
				b(n.length % t == 0),
...
ka.fromName = (c) => (J.typeOf.string("name", c), ka[c]);
var Ob = Object.freeze(ka);
var Va = { MORPHING: 0, COLUMBUS_VIEW: 1, SCENE2D: 2, SCENE3D: 3 };
Va.getMorphTime = (c) =>
	c === Va.SCENE3D ? 1 : c === Va.MORPHING ? void 0 : 0;
...
function ac(c, o) {
	...
	for (const g in c) typeof c[g] == "function" && (c[g] = e);
	c.isDestroyed = _b;
}
var Bb = ac;
function zb() {
	if (!Q(_._canTransferArrayBuffer)) {
		const c = mb("transferTypedArrayTest");
...
function mb(c) {
	...
	if (hb(c)) r = c;
		...
		const p = Na(`${_._workerModulePrefix}/${g}.js`);
		hb(p) && (r = p);
	}
	if (r) {
		const p = `import "${r}";`;
...
async function bc(c, o) {
	const e = { modulePath: void 0, wasmBinaryFile: void 0, wasmBinary: void 0 };
	...
	const g = await Mb.fetchArrayBuffer({ url: e.wasmBinaryFile });
...
async function dc(c, o, e) {
	const g = await Promise.resolve(zb());
...
kb.prototype.rayIntersect = function (c, o, e, g, s) {
	...
	const b = this._inverseTransform,
		r = tc;
...
var lc = new db();
function Hb(c, o, e) {
	const g = gb.rayAxisAlignedBoundingBox(o, c.aabb, lc);
	if (!Q(g)) return;
...
function mc(c, o, e, g, s, b) {
	let r = o.sort((E, F) => E.interval.start - F.interval.start),
		p = Number.MAX_VALUE;
...
function sc(c, o, e, g, s, b) {
	...
	for (let d = 0; d < y; d++) {
		const n = e.intersectingTriangles[d],
...
function sb(c, o, e, g, s, b, r) {
	...
	const F = e.ellipsoid.cartesianToCartographic(p, jc);
	(p = e.project(F, r)), (p = u.fromElements(p.z, p.x, p.y, r));
	const y = $.TWO_PI * e.ellipsoid.maximumRadius,
...
function uc(c, o) {
	const e = c.encoding.exaggeration,
...
var pc = new u(),
	...
	vc = new u();
function Ic(c, o, e) {
	const g = c.encoding.exaggeration,
...
qa.prototype.pick = function (c, o, e, g) {
	const s = this._terrainPicker.rayIntersect(
		c,
		this.getTransform(e, g),
		o,
		e,
		g,
	);
...
pb.createMesh = async (c) => {
	...
	for (let Y = 0; Y < z; Y++) {
		...
		const Xa = P.multiplyByPoint(N, ma, Jc);
...
var Cc = new K(),
	...
	se = new u();
function je(c) {
	const o = c.meshes[0].primitives[0],
	...
	if (b === void 0) {
		const k = c.buffers[g.buffer].extras._pipeline.source;
	...
	const r = c.buffers[b.buffer].extras._pipeline.source,
		p = new Uint8Array(
			r.buffer,
	...
	const A = (1 << (y.BYTES_PER_ELEMENT * 8)) - 1,
...
function ke(c) {
	const o = c.meshes[0].primitives[0],
		...
		b = g.extensions ? g.extensions.EXT_meshopt_compression : void 0;
	if (b === void 0) {
		const A = c.buffers[g.buffer].extras._pipeline.source;
		return new Float32Array(
			A.buffer,
...
function ue(c) {
	...
	if (r === void 0) {
		const y = c.buffers[g.buffer].extras._pipeline.source;
		return new b(
			y.buffer,
	...
	const p = c.buffers[r.buffer].extras._pipeline.source,
		E = new Uint8Array(
			p.buffer,
		...
		F = new b(s);
	return Ua.decodeIndexBuffer(new Uint8Array(F.buffer), s, r.byteStride, E), F;
}
function $a(c, o) {
	const e = c.meshes[0].primitives[0],
	...
	if (p === void 0) {
		const O = c.buffers[s.buffer].extras._pipeline.source;
		return new r(
			O.buffer,
	...
	const E = c.buffers[p.buffer].extras._pipeline.source,
		F = new Uint8Array(
			E.buffer,
...
pb.upsampleMesh = (c) => {
	...
	J.typeOf.bool("options.isEastChild", o),
		...
		J.typeOf.object("options.ellipsoid", c.ellipsoid);
	const r = c.parentIndexCountWithoutSkirts,
		p = c.parentIndices,
	...
	const v = xa.center(t, Zc);
	v.height = 0.5 * (g + s);
	const I = V.toCartesian(v, a, Qc),
		U = h.length,
	...
	const va = ra.fromRectangle(t, ea, da, a, oe),
...
function Sb(c, o, e, g, s, b, r, p) {
	...
	for (let G = 0; G < f; G++) {
		...
		const Y = P.multiplyByPoint(r, oa, be);
		u.minimumByComponent(Y, H, H), u.maximumByComponent(Y, T, T);
	}
	const L = Ha.fromCorners(H, T, le),
		aa = new Fa(
			E.center,
			L,
			X,
...
function Me(c, o, e, g, s, b, r, p) {
	...
	p.length = A;
	for (let j = 0; j < A; j++)
		K.clone(O[j], p.coordinates[j]), u.clone(k[j], p.barycentricCoordinates[j]);
	return p;
}
...
function Be(c, o, e, g, s, b, r, p, E, F, y, A, O, k, j) {
	...
	E.sort((m, w) => j[m * 2 + 1] - j[w * 2 + 1]),
		F.sort((m, w) => j[w * 2 + 0] - j[m * 2 + 0]),
		y.sort((m, w) => j[w * 2 + 1] - j[m * 2 + 1]),
		A.sort((m, w) => j[m * 2 + 0] - j[w * 2 + 0]);
}
var cf = pb;
export { cf as a };
